...
const soxPath = path.join(binPath, 'sox-14.4.2/sox')
const whisperPath = path.join(binPath, 'whisper.cpp/main')
const smallModelPath = path.join(binPath, 'whisper.cpp/models/ggml-small.bin')
